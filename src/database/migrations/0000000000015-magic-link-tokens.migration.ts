...
/**
 * Migration 015 — tenant login_method on auth.organizations, org-scoped magic links,
 ...
 */
export class MagicLinkTokens0000000000015 implements MigrationInterface {
  name = 'MagicLinkTokens0000000000015';

    ...
    let userRolesService: any;
           ...
           beforeEach(async () => {
                 ...
                 authTokenSessionService = {
                         getSubjectAndGroupFromRequest: jest.fn(),
                 };
                 userRolesService = {
           ...
           describe('getStudentBacklog', () => {
                 it('should return error if unauthorized', async () => {
                         // Arrange
                          authTokenSessionService.getSubjectAndGroupFromRequest.mockResolvedValue(null);
                        ...
                        it('should return error if student account not found', async () => {
                                // Arrange
                                 authTokenSessionService.getSubjectAndGroupFromRequest.mockResolvedValue({ userId: 1, primaryRole: 'student' });
           ...
           describe('getGroupBacklog', () => {
                 it('should return error if unauthorized', async () => {
                        ...
                        it('should return error if user role does not have privileges', async () => {
                                // Arrange
                                 authTokenSessionService.getSubjectAndGroupFromRequest.mockResolvedValue({ userId: 1, primaryRole: 'student' });
                                userRolesService.findAccountIdForRole.mockResolvedValue(1);
                        ...
                        it('should return error if lecturer does not own the group', async () => {
                                // Arrange
                                 ...
                                 authTokenSessionService.getSubjectAndGroupFromRequest.mockResolvedValue({ userId: 1, primaryRole: 'lecturer' });
                                userRolesService.findAccountIdForRole.mockResolvedValue(10);

...
ALTER SCHEMA analytics OWNER TO dev_user;
...
ALTER SCHEMA auth OWNER TO dev_user;
...
ALTER SCHEMA education OWNER TO dev_user;
...
ALTER SCHEMA gamification OWNER TO dev_user;
...
-- Name: serwisy; Type: SCHEMA; Schema: -; Owner: dev_user
--

CREATE SCHEMA serwisy;
...
COMMENT ON SCHEMA serwisy IS 'Tables for services and other.';
...
ALTER TABLE analytics.activity_backlog OWNER TO dev_user;
...
ALTER TABLE analytics.backlog OWNER TO dev_user;
...
ALTER TABLE auth.organizations OWNER TO dev_user;
...
ALTER TABLE auth.users OWNER TO dev_user;
...
ALTER TABLE education.activities OWNER TO dev_user;
...
ALTER TABLE education.stages OWNER TO dev_user;
...
ALTER TABLE education.groups OWNER TO dev_user;
...
ALTER TABLE education.posts OWNER TO dev_user;
...
ALTER TABLE gamification.badges OWNER TO dev_user;
...
ALTER TABLE gamification.earned_badges OWNER TO dev_user;
...
ALTER TABLE gamification.enrollments OWNER TO dev_user;
...
ALTER TABLE gamification.shop_items OWNER TO dev_user;
...
ALTER TABLE gamification.ranks OWNER TO dev_user;
...
ALTER TABLE gamification.student_stats OWNER TO dev_user;
...
ALTER TABLE gamification.transactions OWNER TO dev_user;
...
-- Name: drive; Type: TABLE; Schema: serwisy; Owner: dev_user
--

CREATE TABLE serwisy.drive (
    id integer NOT NULL,
    ref uuid NOT NULL,
...
COMMENT ON TABLE serwisy.drive IS 'Table for storing references of organization''s files.';
...
COMMENT ON COLUMN serwisy.drive.id IS 'Reference id.';
...
COMMENT ON COLUMN serwisy.drive.ref IS 'Unique reference';
...
COMMENT ON COLUMN serwisy.drive.size IS 'File''s size.';
...
COMMENT ON COLUMN serwisy.drive.mime_type IS 'Mime type.';
...
COMMENT ON COLUMN serwisy.drive.created_at IS 'UTC+tz when file is created.';
...
COMMENT ON COLUMN serwisy.drive.organization_id IS 'Organization id, where stored.';


--
-- TOC entry 239 (class 1259 OID 3452993)
-- Name: drive_id_seq; Type: SEQUENCE; Schema: serwisy; Owner: dev_user
--

CREATE SEQUENCE serwisy.drive_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE serwisy.drive_id_seq OWNED BY serwisy.drive.id;


--
-- TOC entry 241 (class 1259 OID 3452997)
-- Name: drive_organization_id_seq; Type: SEQUENCE; Schema: serwisy; Owner: dev_user
--

CREATE SEQUENCE serwisy.drive_organization_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE serwisy.drive_organization_id_seq OWNED BY serwisy.drive.organization_id;


--
-- TOC entry 240 (class 1259 OID 3452995)
-- Name: drive_size_seq; Type: SEQUENCE; Schema: serwisy; Owner: dev_user
--

CREATE SEQUENCE serwisy.drive_size_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE serwisy.drive_size_seq OWNED BY serwisy.drive.size;


--
-- TOC entry 2944 (class 2604 OID 3451679)
...
--
-- TOC entry 2942 (class 2604 OID 3451657)
...
--
-- TOC entry 2925 (class 2604 OID 3451455)
...
--
-- TOC entry 2924 (class 2604 OID 3451447)
...
--
-- TOC entry 2946 (class 2604 OID 3452877)
...
--
-- TOC entry 2922 (class 2604 OID 3451433)
...
--
-- TOC entry 2930 (class 2604 OID 3451519)
...
--
-- TOC entry 2926 (class 2604 OID 3451473)
...
--
-- TOC entry 2928 (class 2604 OID 3451490)
...
--
-- TOC entry 2929 (class 2604 OID 3451506)
...
--
-- TOC entry 2937 (class 2604 OID 3451591)
...
--
-- TOC entry 2938 (class 2604 OID 3451607)
...
--
-- TOC entry 2932 (class 2604 OID 3451536)
...
--
-- TOC entry 2933 (class 2604 OID 3451556)
...
--
-- TOC entry 2939 (class 2604 OID 3451625)
...
--
-- TOC entry 2934 (class 2604 OID 3451569)
...
--
-- TOC entry 2940 (class 2604 OID 3451638)
...
--
-- TOC entry 2947 (class 2604 OID 3453002)
-- Name: drive id; Type: DEFAULT; Schema: serwisy; Owner: dev_user
--

ALTER TABLE ONLY serwisy.drive ALTER COLUMN id SET DEFAULT nextval('serwisy.drive_id_seq'::regclass);


--
-- TOC entry 3179 (class 0 OID 3451676)
-- Dependencies: 236
...
--
-- TOC entry 3177 (class 0 OID 3451654)
-- Dependencies: 234
...
--
-- TOC entry 3153 (class 0 OID 3451452)
-- Dependencies: 210
...
--
-- TOC entry 3151 (class 0 OID 3451444)
-- Dependencies: 208
...
--
-- TOC entry 3181 (class 0 OID 3452874)
-- Dependencies: 238
...
--
-- TOC entry 3149 (class 0 OID 3451430)
-- Dependencies: 206
...
--
-- TOC entry 3161 (class 0 OID 3451516)
-- Dependencies: 218
...
--
-- TOC entry 3155 (class 0 OID 3451470)
-- Dependencies: 212
...
--
-- TOC entry 3157 (class 0 OID 3451487)
-- Dependencies: 214
...
--
-- TOC entry 3159 (class 0 OID 3451503)
-- Dependencies: 216
...
--
-- TOC entry 3169 (class 0 OID 3451588)
-- Dependencies: 226
-- Data for Name: badges; Type: TABLE DATA; Schema: gamification; Owner: dev_user
--

COPY gamification.badges (id, group_id, name, requirement_description, icon, rarity) FROM stdin;
\.


--
-- TOC entry 3171 (class 0 OID 3451604)
-- Dependencies: 228
...
--
-- TOC entry 3163 (class 0 OID 3451533)
-- Dependencies: 220
...
--
-- TOC entry 3165 (class 0 OID 3451553)
-- Dependencies: 222
-- Data for Name: ranks; Type: TABLE DATA; Schema: gamification; Owner: dev_user
--

COPY gamification.ranks (id, group_id, name, required_points, icon) FROM stdin;
\.


--
-- TOC entry 3173 (class 0 OID 3451622)
-- Dependencies: 230
...
--
-- TOC entry 3167 (class 0 OID 3451566)
-- Dependencies: 224
...
--
-- TOC entry 3175 (class 0 OID 3451635)
-- Dependencies: 232
...
--
-- TOC entry 3185 (class 0 OID 3452999)
-- Dependencies: 242
-- Data for Name: drive; Type: TABLE DATA; Schema: serwisy; Owner: dev_user
--

COPY serwisy.drive (id, ref, size, mime_type, created_at, organization_id) FROM stdin;
\.
...
SELECT pg_catalog.setval('serwisy.drive_id_seq', 1, false);
...
SELECT pg_catalog.setval('serwisy.drive_organization_id_seq', 1, false);
...
SELECT pg_catalog.setval('serwisy.drive_size_seq', 1, false);


--
-- TOC entry 2985 (class 2606 OID 3451682)
...
--
-- TOC entry 2983 (class 2606 OID 3451663)
...
--
-- TOC entry 2955 (class 2606 OID 3451457)
...
--
-- TOC entry 2953 (class 2606 OID 3451449)
...
--
-- TOC entry 2987 (class 2606 OID 3452879)
...
--
-- TOC entry 2989 (class 2606 OID 3452881)
...
--
-- TOC entry 2949 (class 2606 OID 3451441)
...
--
-- TOC entry 2951 (class 2606 OID 3451439)
...
--
-- TOC entry 2963 (class 2606 OID 3451525)
...
--
-- TOC entry 2961 (class 2606 OID 3451508)
...
--
-- TOC entry 2957 (class 2606 OID 3451479)
...
--
-- TOC entry 2959 (class 2606 OID 3451495)
...
--
-- TOC entry 2975 (class 2606 OID 3451596)
...
--
-- TOC entry 2979 (class 2606 OID 3451627)
...
--
-- TOC entry 2969 (class 2606 OID 3451558)
...
--
-- TOC entry 2971 (class 2606 OID 3451575)
...
--
-- TOC entry 2973 (class 2606 OID 3451573)
...
--
-- TOC entry 2981 (class 2606 OID 3451641)
...
--
-- TOC entry 2965 (class 2606 OID 3451540)
...
--
-- TOC entry 2967 (class 2606 OID 3451538)
...
--
-- TOC entry 2977 (class 2606 OID 3451609)
...
--
-- TOC entry 3013 (class 2606 OID 3451688)
...
--
-- TOC entry 3014 (class 2606 OID 3451683)
...
--
-- TOC entry 3015 (class 2606 OID 3451693)
...
--
-- TOC entry 3011 (class 2606 OID 3451664)
...
--
-- TOC entry 3012 (class 2606 OID 3451669)
...
--
-- TOC entry 2994 (class 2606 OID 3451463)
...
--
-- TOC entry 2995 (class 2606 OID 3451458)
...
--
-- TOC entry 3016 (class 2606 OID 3452915)
...
--
-- TOC entry 2999 (class 2606 OID 3451526)
...
--
-- TOC entry 2998 (class 2606 OID 3451509)
...
--
-- TOC entry 2996 (class 2606 OID 3451480)
...
--
-- TOC entry 2997 (class 2606 OID 3451496)
...
--
-- TOC entry 3005 (class 2606 OID 3451597)
...
--
-- TOC entry 3008 (class 2606 OID 3451628)
...
--
-- TOC entry 3002 (class 2606 OID 3451559)
...
--
-- TOC entry 3003 (class 2606 OID 3451581)
...
--
-- TOC entry 3004 (class 2606 OID 3451576)
...
--
-- TOC entry 3009 (class 2606 OID 3451647)
...
--
-- TOC entry 3010 (class 2606 OID 3451642)
...
--
-- TOC entry 3000 (class 2606 OID 3451541)
...
--
-- TOC entry 3001 (class 2606 OID 3451546)
...
--
-- TOC entry 3006 (class 2606 OID 3451615)
...
--
-- TOC entry 3007 (class 2606 OID 3451610)
...
--
-- TOC entry 3017 (class 2606 OID 3453012)
...
-- Completed on 2026-05-13 19:57:00

--
-- dev_userQL database dump complete
--
